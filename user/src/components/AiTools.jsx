...
const AiTools = () => {
    ...
    const {user} = useUser()
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-1'>
        ...
        {AiToolsData.map((tool,index)=>(
            <div key={index} className='p-8 m-4 w-full lg:w-[30%] rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-3 transition-all duration-300 cursor-pointer' onClick={()=>user && navigate(tool.path)}>
